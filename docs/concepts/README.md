...
| 10 | Can a state-space block replace attention, and does a hybrid keep the best of each? | [State-space block](state-space.md) | measured (SS01 fixed decay 4.56, SS02 selective 4.42 at a matched mixer and half the state, against attention's 3.79); HA01 next |
...
| State | how much sequence history stays resident? | state-space block | SS01 and SS02 (measured: 128 to 256 B at any history against 262,144 B for attention at 1,024 tokens); HA01 (Saga 7) |
