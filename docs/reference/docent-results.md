...
| CD01b | docent dense over word vectors (PPMI rank-24 on docs-a.txt, 586 words) in a 1024-slot table, fine-tuned; corpus A, 40 ep, lr 0.003 | mlpl-repl 0.22.0 | 26003 | 1664 | 208024 | 26003 | 1.4543 | 0 | 1.6966 | 0.942 | 0.917 | 0.959 | 0.917 | 0.182 | 0.3 | 0.407 | 0.407 | 0 | - | - | - |
| CD01bf | the same with the table frozen: only the body and heads train | mlpl-repl 0.22.0 | 26003 | 1664 | 208024 | 26003 | 1.504 | 2.9604 | 3.7183 | 0.627 | 0.369 | 0.618 | 0.177 | 0 | 0.5 | 0.259 | 0.333 | 0 | - | - | - |
