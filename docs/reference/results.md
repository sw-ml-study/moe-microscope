...
| EG01@1024 | dense + engram 2,3-gram 1024 slots x8 scratch (table 16384 params 131072 B) d16 h32 1head T28 120ex 300ep lr0.003 | mlpl-repl 0.22.0 | 20996 | 3812 | - | - | 1 | 30496 | - | 0.1378 | 3.9323 | 51.02 | 0 | 0 | 0 | 0.667 | - | - | - | - |
| EG01@256 | dense + engram 2,3-gram 256 slots x8 scratch (table 4096 params 32768 B) d16 h32 1head T28 120ex 300ep lr0.003 | mlpl-repl 0.22.0 | 8708 | 3812 | - | - | 1 | 30496 | - | 0.0641 | 4.6653 | 106.2 | 0 | 0 | 0 | 0 | - | - | - | - |
| EG01@64 | dense + engram 2,3-gram 64 slots x8 scratch (table 1024 params 8192 B) d16 h32 1head T28 120ex 300ep lr0.003 | mlpl-repl 0.22.0 | 5636 | 3812 | - | - | 1 | 30496 | - | 0.044 | 4.4914 | 89.25 | 0 | 0 | 0 | 0 | - | - | - | - |
| EG01@16 | dense + engram 2,3-gram 16 slots x8 scratch (table 256 params 2048 B) d16 h32 1head T28 120ex 300ep lr0.003 | mlpl-repl 0.22.0 | 4868 | 3812 | - | - | 1 | 30496 | - | 0.0315 | 4.2651 | 71.17 | 0 | 0 | 0.286 | 0 | - | - | - | - |
| EG01b@256 | dense + engram 2,3-gram 256 slots x8 builtin (table 4096 params 32768 B) d16 h32 1head T28 120ex 300ep lr0.003 | mlpl-repl 0.22.0 | 8708 | 3812 | - | - | 1 | 30496 | - | 0.0589 | 4.6653 | 106.2 | 0 | 0 | 0 | 0 | - | - | - | - |
